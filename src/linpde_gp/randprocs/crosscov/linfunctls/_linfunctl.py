...
def _(self, pv_crosscov: ScaledProcessVectorCrossCovariance, /) -> pn.linops.LinearOperator:
    return pv_crosscov.scalar * self(pv_crosscov.pv_crosscov)


@LinearFunctional.__call__.register  # pylint: disable=no-member
def _(self, sum_pv_crosscov: SumProcessVectorCrossCovariance, /) -> pn.linops.LinearOperator:
...
def _(self, pv_crosscov: LinOpProcessVectorCrossCovariance, /) -> pn.linops.LinearOperator:
...
def _(self, pv_crosscov: CovarianceFunction_Dirac_Identity, /) -> pn.linops.LinearOperator:
